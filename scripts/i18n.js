(function () {
    ...
    const translations = {
        en: {
            ...
            "whatsNew.v300.title": "More Personalization and Reliability",
            "whatsNew.v300.customization": "<strong>More Widget Customization:</strong><br/>Customize small and medium widgets separately so each size fits your Home Screen.",
            "whatsNew.v300.icons": "<strong>Dynamic App Icons:</strong><br/>Let your app icon follow the selected accent color for a more consistent appearance.",
            "whatsNew.v300.improvements": "<strong>Better Customization:</strong><br/>Enjoy clearer customization screens, improved previews, helpful tips, and expanded localization.",
            "whatsNew.v300.reliability": "<strong>Reliability Improvements:</strong><br/>Widget updates and daily usage tracking include bug fixes and reliability improvements.",
        ...
        de: {
            ...
            "whatsNew.v300.title": "Mehr Personalisierung und Zuverlässigkeit",
            "whatsNew.v300.customization": "<strong>Mehr Widget-Anpassung:</strong><br/>Passe kleine und mittelgroße Widgets separat an, damit jede Größe zu deiner Startseite passt.",
            "whatsNew.v300.icons": "<strong>Dynamische App-Icons:</strong><br/>Lass dein App-Icon der gewählten Akzentfarbe folgen und erhalte ein einheitlicheres Erscheinungsbild.",
            "whatsNew.v300.improvements": "<strong>Bessere Anpassung:</strong><br/>Nutze übersichtlichere Anpassungsseiten, verbesserte Vorschauen, hilfreiche Tipps und eine umfassendere Lokalisierung.",
            "whatsNew.v300.reliability": "<strong>Zuverlässigkeitsverbesserungen:</strong><br/>Widget-Aktualisierungen und die tägliche Datenerfassung enthalten Fehlerbehebungen und Verbesserungen.",
        ...
        "zh-Hans": {
            ...
            "help.path.language": "Device Settings > Apps > Data Pill > Language > Select Language",
            "whatsNew.title": "新功能",
            "whatsNew.v300.title": "更多个性化与可靠性提升",
            "whatsNew.v300.customization": "<strong>更多小组件自定义：</strong><br/>分别自定义小尺寸和中尺寸小组件，让每种尺寸都更适合你的主屏幕。",
            "whatsNew.v300.icons": "<strong>动态 App 图标：</strong><br/>让 App 图标跟随所选强调色，获得更统一的外观。",
            "whatsNew.v300.improvements": "<strong>更好的自定义体验：</strong><br/>享受更清晰的自定义页面、更好的预览、实用提示和更完整的本地化支持。",
            "whatsNew.v300.reliability": "<strong>可靠性提升：</strong><br/>小组件更新和每日数据追踪加入了错误修复与可靠性改进。",
        ...
        tr: {
            ...
            "whatsNew.v300.title": "Daha Fazla Kişiselleştirme ve Güvenilirlik",
            "whatsNew.v300.customization": "<strong>Daha Fazla Widget Özelleştirmesi:</strong><br/>Küçük ve orta boy widget'ları ayrı ayrı özelleştirerek her boyutu Ana Ekranına uygun hale getir.",
            "whatsNew.v300.icons": "<strong>Dinamik Uygulama Simgeleri:</strong><br/>Daha tutarlı bir görünüm için uygulama simgenin seçtiğin vurgu rengini takip etmesini sağla.",
            "whatsNew.v300.improvements": "<strong>Daha İyi Özelleştirme:</strong><br/>Daha anlaşılır özelleştirme ekranlarının, geliştirilmiş önizlemelerin, faydalı ipuçlarının ve genişletilmiş yerelleştirmenin keyfini çıkar.",
            "whatsNew.v300.reliability": "<strong>Güvenilirlik İyileştirmeleri:</strong><br/>Widget güncellemeleri ve günlük veri takibi hata düzeltmeleri ve güvenilirlik iyileştirmeleri içerir.",
        ...
        fil: {
            ...
            "whatsNew.v300.title": "Mas Maraming Personalization at Reliability",
            "whatsNew.v300.customization": "<strong>Mas Maraming Widget Customization:</strong><br/>I-customize nang hiwalay ang small at medium widgets para bagay ang bawat size sa Home Screen mo.",
            "whatsNew.v300.icons": "<strong>Dynamic App Icons:</strong><br/>Ipa-follow sa app icon ang napiling accent color para mas consistent ang itsura.",
            "whatsNew.v300.improvements": "<strong>Mas Maayos na Customization:</strong><br/>Mas malinaw na customization screens, improved previews, helpful tips, at mas malawak na localization.",
            "whatsNew.v300.reliability": "<strong>Reliability Improvements:</strong><br/>May bug fixes at reliability improvements para sa widget updates at daily usage tracking.",
