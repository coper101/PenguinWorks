(function () {
    ...
    const translations = {
        en: {
            ...
            "whatsNew.v320.title": "Daily Budget & a Refreshed Home",
            "whatsNew.v320.budget": "<strong>Automatic Daily Budget:</strong><br/>See a suggested daily amount based on your remaining plan data and days left.",
            "whatsNew.v320.home": "<strong>A Clearer Home View:</strong><br/>Check days left, daily budget, weekly usage, and plan progress in a cleaner, more compact layout.",
            "whatsNew.v320.switching": "<strong>Daily and Plan Views:</strong><br/>Switch between daily and plan usage with a tap or horizontal swipe.",
            "whatsNew.v320.reliability": "<strong>Reliability &amp; Layout Improvements:</strong><br/>Plan changes, period rollovers, and tips are now more reliable and polished.",
            "whatsNew.v310.title": "Multiple Plans, Easier Management",
            "whatsNew.v310.multiple": "<strong>Multiple Data Plans:</strong><br/>Create and name additional plans so different mobile services or billing arrangements can be tracked separately. Additional plans require Super Pill.",
            "whatsNew.v310.switching": "<strong>Quick Plan Switching:</strong><br/>Open the plan list from My Plan, see the active plan at a glance, and switch plans while keeping each plan's usage records separate.",
            "whatsNew.v310.management": "<strong>Safer Plan Management:</strong><br/>Rename plans, delete plans with a confirmation, and automatically move to another remaining plan when the active plan is removed.",
            "whatsNew.v310.reliability": "<strong>Reliability Improvements:</strong><br/>Plan-data migration, persistence, widget synchronization, and usage tracking have been updated to support multiple plans reliably.",
        ...
        de: {
            ...
            "whatsNew.v320.title": "Tagesbudget & eine übersichtlichere Startseite",
            "whatsNew.v320.budget": "<strong>Automatisches Tagesbudget:</strong><br/>Sieh einen vorgeschlagenen Tagesbetrag basierend auf deinem verbleibenden Datenvolumen und den verbleibenden Tagen.",
            "whatsNew.v320.home": "<strong>Klarere Startansicht:</strong><br/>Sieh verbleibende Tage, Tagesbudget, Wochenverbrauch und Planfortschritt in einem aufgeräumteren, kompakteren Layout.",
            "whatsNew.v320.switching": "<strong>Tages- und Planansicht:</strong><br/>Wechsle mit einem Tippen oder horizontalen Wischen zwischen Tages- und Plannutzung.",
            "whatsNew.v320.reliability": "<strong>Verbesserungen bei Zuverlässigkeit und Layout:</strong><br/>Planwechsel, Periodenwechsel und Tipps sind jetzt zuverlässiger und übersichtlicher.",
            "whatsNew.v310.title": "Mehrere Tarife, einfachere Verwaltung",
            "whatsNew.v310.multiple": "<strong>Mehrere Datentarife:</strong><br/>Erstelle und benenne zusätzliche Tarife, um verschiedene Mobilfunkdienste oder Abrechnungsmodelle getrennt zu verfolgen. Zusätzliche Tarife erfordern Super Pill.",
            "whatsNew.v310.switching": "<strong>Schneller Tarifwechsel:</strong><br/>Öffne die Tarifliste über Mein Tarif, sieh den aktiven Tarif sofort und wechsle zwischen Tarifen, während die Nutzungsdaten getrennt bleiben.",
            "whatsNew.v310.management": "<strong>Sicherere Tarifverwaltung:</strong><br/>Benenne Tarife um, lösche sie mit einer Bestätigung und wechsle automatisch zu einem verbleibenden Tarif, wenn der aktive Tarif gelöscht wird.",
            "whatsNew.v310.reliability": "<strong>Zuverlässigkeitsverbesserungen:</strong><br/>Tarifdatenmigration, Speicherung, Widget-Synchronisierung und Nutzungserfassung wurden für mehrere Tarife verbessert.",
        ...
        "zh-Hans": {
            ...
            "help.path.language": "Device Settings > Apps > Data Pill > Language > Select Language",
            "whatsNew.title": "新功能",
            "whatsNew.v320.title": "每日预算与焕新主页",
            "whatsNew.v320.budget": "<strong>自动每日预算：</strong><br/>根据剩余套餐流量和剩余天数查看建议的每日用量。",
            "whatsNew.v320.home": "<strong>更清晰的主页视图：</strong><br/>在更简洁、紧凑的布局中查看剩余天数、每日预算、本周用量和套餐进度。",
            "whatsNew.v320.switching": "<strong>每日与套餐视图：</strong><br/>轻点或水平滑动即可在每日用量和套餐用量之间切换。",
            "whatsNew.v320.reliability": "<strong>可靠性与布局改进：</strong><br/>套餐切换、周期更新和提示现在更加可靠、完善。",
            "whatsNew.v310.title": "多个套餐，更轻松的管理",
            "whatsNew.v310.multiple": "<strong>多个数据套餐：</strong><br/>创建并命名额外套餐，分别追踪不同的移动服务或计费方式。添加额外套餐需要 Super Pill。",
            "whatsNew.v310.switching": "<strong>快速切换套餐：</strong><br/>从我的套餐打开套餐列表，一眼查看当前套餐，并在保持各套餐使用记录独立的同时进行切换。",
            "whatsNew.v310.management": "<strong>更安全的套餐管理：</strong><br/>重命名套餐、通过确认删除套餐，并在删除当前套餐后自动切换到其他剩余套餐。",
            "whatsNew.v310.reliability": "<strong>可靠性提升：</strong><br/>套餐数据迁移、保存、小组件同步和用量追踪均已更新，以更可靠地支持多个套餐。",
        ...
        tr: {
            ...
            "whatsNew.v320.title": "Günlük Bütçe ve Yenilenen Ana Ekran",
            "whatsNew.v320.budget": "<strong>Otomatik Günlük Bütçe:</strong><br/>Kalan plan verine ve gün sayısına göre önerilen günlük miktarı gör.",
            "whatsNew.v320.home": "<strong>Daha Net Ana Ekran:</strong><br/>Kalan günleri, günlük bütçeyi, haftalık kullanımı ve plan ilerlemesini daha temiz, kompakt bir düzende gör.",
            "whatsNew.v320.switching": "<strong>Günlük ve Plan Görünümleri:</strong><br/>Tek dokunuşla veya yatay kaydırmayla günlük ve plan kullanımı arasında geçiş yap.",
            "whatsNew.v320.reliability": "<strong>Güvenilirlik ve Düzen İyileştirmeleri:</strong><br/>Plan değişiklikleri, dönem geçişleri ve ipuçları artık daha güvenilir ve özenli.",
            "whatsNew.v310.title": "Birden Fazla Plan, Daha Kolay Yönetim",
            "whatsNew.v310.multiple": "<strong>Birden Fazla Veri Planı:</strong><br/>Farklı mobil hizmetleri veya faturalandırma düzenlerini ayrı ayrı takip etmek için ek planlar oluştur ve adlandır. Ek planlar için Super Pill gerekir.",
            "whatsNew.v310.switching": "<strong>Hızlı Plan Değiştirme:</strong><br/>Plan listesini Planım bölümünden aç, aktif planı bir bakışta gör ve her planın kullanım kayıtlarını ayrı tutarak planlar arasında geçiş yap.",
            "whatsNew.v310.management": "<strong>Daha Güvenli Plan Yönetimi:</strong><br/>Planları yeniden adlandır, onayla sil ve aktif plan kaldırıldığında otomatik olarak kalan başka bir plana geç.",
            "whatsNew.v310.reliability": "<strong>Güvenilirlik İyileştirmeleri:</strong><br/>Plan verisi aktarımı, kalıcılık, widget senkronizasyonu ve kullanım takibi birden fazla planı daha güvenilir destekleyecek şekilde güncellendi.",
        ...
        fil: {
            ...
            "whatsNew.v320.title": "Daily Budget at Mas Maayos na Home",
            "whatsNew.v320.budget": "<strong>Automatic Daily Budget:</strong><br/>Makita ang suggested daily amount batay sa natitirang plan data at days left.",
            "whatsNew.v320.home": "<strong>Mas Malinaw na Home View:</strong><br/>Tingnan ang days left, daily budget, weekly usage, at plan progress sa mas malinis at compact na layout.",
            "whatsNew.v320.switching": "<strong>Daily at Plan Views:</strong><br/>Lumipat sa daily at plan usage gamit ang tap o horizontal swipe.",
            "whatsNew.v320.reliability": "<strong>Reliability at Layout Improvements:</strong><br/>Mas maaasahan at pulido na ang plan changes, period rollovers, at tips.",
            "whatsNew.v310.title": "Maraming Plan, Mas Madaling Pamamahala",
            "whatsNew.v310.multiple": "<strong>Maraming Data Plan:</strong><br/>Gumawa at magbigay ng pangalan sa karagdagang plans para magkahiwalay na ma-track ang iba't ibang mobile services o billing arrangements. Kailangan ng Super Pill para sa additional plans.",
            "whatsNew.v310.switching": "<strong>Mabilis na Pagpalit ng Plan:</strong><br/>Buksan ang plan list mula sa My Plan, tingnan agad ang active plan, at lumipat ng plan habang hiwalay ang usage records ng bawat isa.",
            "whatsNew.v310.management": "<strong>Mas Ligtas na Plan Management:</strong><br/>Mag-rename ng plans, mag-delete gamit ang confirmation, at awtomatikong lumipat sa natitirang plan kapag tinanggal ang active plan.",
            "whatsNew.v310.reliability": "<strong>Reliability Improvements:</strong><br/>Na-update ang plan-data migration, persistence, widget synchronization, at usage tracking para mas maaasahang suportahan ang maraming plans.",
