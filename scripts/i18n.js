(function () {
    ...
    const translations = {
        en: {
            ...
            "whatsNew.v300.title": "A More Personal Data Pill",
            "whatsNew.v300.home": "<strong>Home Screen Refresh:</strong><br/>See weekly data, status, and days left together in a brighter, more flexible Home Screen.",
            "whatsNew.v300.pill": "<strong>Pill Customization:</strong><br/>Customize Daily and Weekly pills with day colors, backgrounds, and more visual choices.",
            "whatsNew.v300.widgets": "<strong>Widget Customization:</strong><br/>Personalize Days Left and Status widgets with presets, gradients, colors, and text options.",
            "whatsNew.v300.appearance": "<strong>App Icon & Accent:</strong><br/>Choose your app icon and accent color, or sync them together for a consistent look.",
            "whatsNew.v300.tips": "<strong>Widget Tips:</strong><br/>Follow the new guide to add Data Pill widgets and choose the view that works best for you.",
        ...
        de: {
            ...
            "whatsNew.v300.title": "Eine persönlichere Data Pill",
            "whatsNew.v300.home": "<strong>Überarbeitete Startseite:</strong><br/>Sieh Wochenverbrauch, Status und verbleibende Tage gemeinsam auf einer helleren und flexibleren Startseite.",
            "whatsNew.v300.pill": "<strong>Pill-Anpassung:</strong><br/>Passe tägliche und wöchentliche Pills mit Tagesfarben, Hintergründen und weiteren visuellen Optionen an.",
            "whatsNew.v300.widgets": "<strong>Widget-Anpassung:</strong><br/>Personalisiere Tage-übrig- und Status-Widgets mit Presets, Verläufen, Farben und Textoptionen.",
            "whatsNew.v300.appearance": "<strong>App-Icon und Akzent:</strong><br/>Wähle dein App-Icon und deine Akzentfarbe oder synchronisiere beides für einen einheitlichen Look.",
            "whatsNew.v300.tips": "<strong>Widget-Tipps:</strong><br/>Die neue Anleitung hilft dir, Data Pill Widgets hinzuzufügen und die passende Ansicht auszuwählen.",
        ...
        "zh-Hans": {
            ...
            "help.path.language": "Device Settings > Apps > Data Pill > Language > Select Language",
            "whatsNew.title": "新功能",
            "whatsNew.v300.title": "更个性化的 Data Pill",
            "whatsNew.v300.home": "<strong>全新主屏幕：</strong><br/>在更明亮、更灵活的主屏幕上一览每周数据、状态和剩余天数。",
            "whatsNew.v300.pill": "<strong>自定义 Pill：</strong><br/>使用每日和每周样式、每日颜色、背景等更多视觉选项自定义 Pill。",
            "whatsNew.v300.widgets": "<strong>自定义小组件：</strong><br/>使用预设、渐变、颜色和文字选项个性化剩余天数和状态小组件。",
            "whatsNew.v300.appearance": "<strong>App 图标和强调色：</strong><br/>选择 App 图标和强调色，也可以将它们同步以保持统一外观。",
            "whatsNew.v300.tips": "<strong>小组件提示：</strong><br/>通过新指南添加 Data Pill 小组件，并选择最适合你的视图。",
        ...
        tr: {
            ...
            "whatsNew.v300.title": "Daha Kişisel Bir Data Pill",
            "whatsNew.v300.home": "<strong>Ana Ekran Yenilendi:</strong><br/>Haftalık veriyi, durumu ve kalan günleri daha aydınlık ve esnek bir Ana Ekranda birlikte gör.",
            "whatsNew.v300.pill": "<strong>Pill Özelleştirme:</strong><br/>Günlük ve Haftalık Pill'leri gün renkleri, arka planlar ve daha fazla görsel seçenekle özelleştir.",
            "whatsNew.v300.widgets": "<strong>Widget Özelleştirme:</strong><br/>Kalan Günler ve Durum widget'larını hazır ayarlar, geçişler, renkler ve metin seçenekleriyle kişiselleştir.",
            "whatsNew.v300.appearance": "<strong>Uygulama Simgesi ve Vurgu Rengi:</strong><br/>Uygulama simgesini ve vurgu rengini seç veya tutarlı bir görünüm için ikisini senkronize et.",
            "whatsNew.v300.tips": "<strong>Widget İpuçları:</strong><br/>Data Pill widget'larını eklemek ve sana en uygun görünümü seçmek için yeni rehberi takip et.",
        ...
        fil: {
            ...
            "whatsNew.v300.title": "Mas Personal na Data Pill",
            "whatsNew.v300.home": "<strong>Bagong Home Screen:</strong><br/>Makita nang magkasama ang weekly data, status, at days left sa mas maliwanag at flexible na Home Screen.",
            "whatsNew.v300.pill": "<strong>Pill Customization:</strong><br/>I-customize ang Daily at Weekly pills gamit ang day colors, backgrounds, at iba pang visual options.",
            "whatsNew.v300.widgets": "<strong>Widget Customization:</strong><br/>I-personalize ang Days Left at Status widgets gamit ang presets, gradients, colors, at text options.",
            "whatsNew.v300.appearance": "<strong>App Icon at Accent:</strong><br/>Piliin ang app icon at accent color, o i-sync ang mga ito para sa consistent na look.",
            "whatsNew.v300.tips": "<strong>Widget Tips:</strong><br/>Sundin ang bagong guide para magdagdag ng Data Pill widgets at piliin ang view na pinakaangkop sa iyo.",
